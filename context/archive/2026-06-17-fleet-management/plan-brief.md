...
- **Parallel with S-03.** Shared-merge surfaces: `dashboard.astro`, `types.ts`, generated `database.types.ts` (regen once after _both_ migrations). No `access.ts` change in S-04.
