...
- [x] 11.1 Unit tests pass: `npm test` — ca7a558
- [x] 11.2 Lint passes: `npm run lint` — ca7a558
- [x] 11.3 Type checking passes: `npx astro check` — ca7a558
- [x] 11.4 Integration tests pass: `npm run test:integration` — ca7a558
- [x] 11.5 Production build succeeds: `npm run build` — ca7a558
- [x] 11.6 E2E asserts in-viewport AND topmost-at-its-own-centre for a failed `Przywróć` at 390×844 — ca7a558
- [x] 11.7 E2E suite passes on `:4321`: `npm run test:e2e` — ca7a558
- [x] 11.8 The shipped surface is phase 10 §3's answer, not a fleet-specific variant — ca7a558
- [x] 11.9 `design-contract.md` carries the fleet banner's measured values and §11 rows — ca7a558

#### Manual

- [x] 11.10 A failed `Przywróć` from a row below the fold is readable without scrolling — ca7a558
- [x] 11.11 The retire confirm dialog's in-dialog error is unchanged — ca7a558
- [x] 11.12 The §3 decisions — vanishing anchor, and restore-success feedback — are recorded as in-scope or follow-up — ca7a558
- [x] 11.13 The fleet banner matches its design entry verbatim at 1280px and 390px — ca7a558
