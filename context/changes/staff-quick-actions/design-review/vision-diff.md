...
| E12 — desktop never absorbs  | canonical rows on every page                           | verified on all 7 routes: `Nowa rezerwacja [crimson]                                                         | Dodaj pojazd [grey]`, including `/dashboard/vehicles`and`/dashboard/staff` |
