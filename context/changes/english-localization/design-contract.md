...
| 4   | `LangToggle` has **no open/dropdown state** — it renders a caret but click toggles EN⇄PL directly. The caret promises a menu that never appears.                                                                                                                                                                | Medium           | `deviation` recorded below.                                                                                    |
...
| caret icon      | `10×10`, stroke width `2.4`, `opacity 0.6`               | stroke `#fff`                      | exact |
...
- `deviation(caret promises a menu)` — the design renders a caret but click toggles EN⇄PL directly.
  We keep the caret **and** the direct toggle (two locales make a menu pointless), matching the
  design's rendered appearance; revisit if a third locale lands.
