...
- [ ] 7.1 `npm run test:integration` passes all new return suites
- [ ] 7.2 `npm test`, `npm run lint`, `npm run build` all pass
- [ ] 7.3 Full existing suite stays green (no issue-flow regression)
