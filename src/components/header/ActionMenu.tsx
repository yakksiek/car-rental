...
export default function ActionMenu({ tone = "light" }: Props) {
      ...
      >
        ...
        >
          ...
          <span className="min-w-0">
            <span className="text-foreground block text-[13.5px] font-[650] tracking-[-0.15px]">Zadzwoń</span>
        ...
        >
          ...
          <span className="text-foreground text-[13.5px] font-[650] tracking-[-0.15px]">Przeglądaj flotę</span>
        </a>
      </PopoverContent>
    </Popover>
  );
