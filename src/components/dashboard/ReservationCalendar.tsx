...
export default function ReservationCalendar({
  ...
  // tags each day-number element `data-testid="day-number-<D>"` (or
  // `day-number-today`); we poll briefly because the resource grid mounts after
  ...
  React.useEffect(() => {
    ...
    const testid = initialDate === todayIso ? "day-number-today" : `day-number-${day}`;
